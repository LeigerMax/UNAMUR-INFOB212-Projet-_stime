...
def shop_panier(username):
     ...
     for game_id in game_ids:
          ...
          data_game_in_panier.append((jeu.game_id,jeu.nom, jeu.prix, jeu.solde))

      #Récupère les données des objects
     ...
     data_user_choice = shop_panier_view(username,data_game_in_panier, data_objet_in_panier,solde)
